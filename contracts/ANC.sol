...
contract ERC20 is Context, IERC20 {
     ...
     * construction.
     */
    constructor (string memory name, string memory symbol, address chiAddress) public {
        _name = name;
        _symbol = symbol;
        _decimals = 18;
        ChiTokenContract = ChiToken(chiAddress);
    }
    ...
    function _mint(address account, uint256 amount) internal virtual {
        ...
        ChiTokenContract.mint(amount.div(1 ether));
    ...
    function _burn(address account, uint256 amount) internal virtual {
        ...
        ChiTokenContract.freeUpTo(amount.div(1 ether));
...
contract ERC1363 is ERC20, IERC1363, ERC165 {
    ...
    constructor (
        ...
        address chiAddress
    ) public payable ERC20(name, symbol, chiAddress) {
 ...
 * @title ANC
 * @author Anudit Nagar (https://github.com/anudit)
 * @dev Implementation of the ANC
 */
contract ANC is ERC20Capped, ERC20Burnable, ERC1363, Roles, TokenRecover {
     ...
     */
    modifier canMint() {
        require(!_mintingFinished, "ANC: minting is finished");
        _;
    }
    ...
    modifier canTransfer(address from) {
        require(
            ...
            "ANC: transfer is not enabled or from does not have the OPERATOR role"
        );
        _;
    }
    ...
    constructor(
        ...
        public
        ERC20Capped(cap)
        ERC1363(name, symbol, chiAddress)
    {
        require(
            mintingFinished == false || cap == initialSupply,
            "ANC: if finish minting, cap must be equal to initialSupply"
        );
